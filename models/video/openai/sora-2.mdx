...
description: "Generate videos using Sora 2 via PixelByte API"
---

Generate videos with OpenAI's Sora 2 model. Supports text-to-video and image-to-video capabilities with multiple duration options.
