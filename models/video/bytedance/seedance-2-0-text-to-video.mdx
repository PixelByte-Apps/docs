...
description: "Generate cinematic videos from text prompts using ByteDance's Seedance 2.0 model"
---

Generate cinematic videos from text descriptions with ByteDance's Seedance 2.0. Supports configurable resolution, frame rate, duration, and aspect ratios.
...
<ParamField body="model" type="string" required placeholder="bytedance/seedance-2.0/text-to-video">
  Model slug. Use `bytedance/seedance-2.0/text-to-video` for text-to-video generation.
</ParamField>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    ...
    "input": {
      "prompt": "A cinematic shot of a lone astronaut walking across a glowing alien desert at sunset",
      "aspect_ratio": "16:9",
      "duration": "5",
      "resolution": "720p",
      "fps": "24"
