...
description: "Faster text-to-video generation with ByteDance's Seedance 2.0 Fast model"
---
...
<ParamField body="model" type="string" required placeholder="bytedance/seedance-2.0-fast/text-to-video">
