---
title: "Wan 2.6 — Video Extend"
api: "POST /v1/jobs/submit"
description: "Generate video extend outputs using Alibaba+'s Wan 2.6 model via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="alibaba-plus/wan-2.6/video-extend">
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "alibaba-plus/wan-2.6/video-extend",
    "input": {
