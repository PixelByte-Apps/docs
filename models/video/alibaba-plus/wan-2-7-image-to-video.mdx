...
description: "Generate image to video outputs using Alibaba+'s Wan 2.7 model via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="alibaba-plus/wan-2.7/image-to-video">
...
<ParamField body="input" type="object" required>
  ...
  <Expandable title="properties" defaultOpen>
    ...
    <ParamField body="input_video_url" type="string">
