---
title: "Wan 2.6 Super — Image to Video"
api: "POST /v1/jobs/submit"
description: "Generate image to video outputs using Alibaba+'s Wan 2.6 Super model via PixelByte API"
---

Generate image to video outputs with Alibaba+'s Wan 2.6 Super model. Submitted as an asynchronous job and delivered via webhook or polling.
...
<ParamField body="model" type="string" required placeholder="alibaba-plus/wan-2.6-super/image-to-video">
  Model slug. Use `alibaba-plus/wan-2.6-super/image-to-video` for image to video generation.
</ParamField>
...
<Tip>
**Default cost:** 720p resolution, 5 duration = 100,000 × 1 × 5 = **500,000 micro-cents ($0.50)**
</Tip>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "alibaba-plus/wan-2.6-super/image-to-video",
    "input": {
