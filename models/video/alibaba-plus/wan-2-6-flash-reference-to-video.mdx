---
title: "Wan 2.6 Flash — Reference to Video"
api: "POST /v1/jobs/submit"
description: "Generate reference to video outputs using Alibaba+'s Wan 2.6 Flash model via PixelByte API"
---

Generate reference to video outputs with Alibaba+'s Wan 2.6 Flash model. Submitted as an asynchronous job and delivered via webhook or polling.
...
<ParamField body="model" type="string" required placeholder="alibaba-plus/wan-2.6-flash/reference-to-video">
  Model slug. Use `alibaba-plus/wan-2.6-flash/reference-to-video` for reference to video generation.
</ParamField>
...
<ParamField body="input" type="object" required>
  ...
  <Expandable title="properties" defaultOpen>
    ...
    <ParamField body="reference_urls" type="array" required>
      Reference images/videos (max 5 total).
    </ParamField>
    <ParamField body="aspect_ratio" type="string">
      Output aspect ratio. Default: `"16:9"`. Options: `16:9`, `9:16`.
    </ParamField>
...
<Tip>
**Default cost:** 5 duration = 100,000 × 5 = **500,000 micro-cents ($0.50)**
</Tip>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "alibaba-plus/wan-2.6-flash/reference-to-video",
    "input": {
      "prompt": "A serene lake at sunrise with mist rolling over the water",
      "reference_urls": ["https://example.com/image.jpg"],
      "aspect_ratio": "16:9",
      "duration": "5"
    }
  }'
