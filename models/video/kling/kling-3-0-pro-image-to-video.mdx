...
description: "Generate videos from images using Kling 3.0 Pro model"
---
...
<ParamField body="model" type="string" required placeholder="kling/kling-3.0-pro/image-to-video">
