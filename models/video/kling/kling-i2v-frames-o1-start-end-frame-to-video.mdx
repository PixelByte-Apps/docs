---
title: "Kling O1 — Start-End Frame to Video"
api: "POST /v1/jobs/submit"
description: "Generate videos that interpolate between start and end frames using Kling O1 via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="kling/kling-i2v-frames-o1/start-end-frame-to-video">
