---
title: "Kling I2V Frames V2.5 — Image to Video"
api: "POST /v1/jobs/submit"
description: "Generate videos from a single image with Kling I2V Frames V2.5"
---
...
<ParamField body="model" type="string" required placeholder="kling/kling-i2v-frames-v25/image-to-video">
