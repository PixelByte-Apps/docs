...
description: "Generate videos from images using Kling 3.0 Standard model"
---

Generate high-quality videos from an image and text prompt with Kling 3.0 Standard. Supports multiple aspect ratios, durations, and optional audio generation.
...
<ParamField body="model" type="string" required placeholder="kling/kling-3.0-standard/image-to-video">
  Model slug. Use `kling/kling-3.0-standard/image-to-video` for image-to-video generation.
</ParamField>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "kling/kling-3.0-standard/image-to-video",
    "input": {
