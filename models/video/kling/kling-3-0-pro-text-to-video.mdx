...
description: "Generate videos from text prompts using Kling 3.0 Pro model"
---

Generate high-quality videos from text descriptions with Kling 3.0 Pro. Supports multiple aspect ratios, durations, and optional audio generation.
...
<ParamField body="model" type="string" required placeholder="kling/kling-3.0-pro/text-to-video">
  Model slug. Use `kling/kling-3.0-pro/text-to-video` for text-to-video generation.
</ParamField>
