...
description: "Generate videos from start and end frame images using Kling 3.0 Standard model"
---
...
<ParamField body="model" type="string" required placeholder="kling/kling-3.0-standard/start-end-frame-to-video">
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "kling/kling-3.0-standard/start-end-frame-to-video",
    "input": {
