---
title: "Kling O1 Pro — Start-End Frame to Video"
api: "POST /v1/jobs/submit"
description: "Generate videos with the Kling O1 Pro model using start-end frame to video."
---

Generate a video that smoothly transitions between two frames using the Kling O1 Pro model. Provide start and end frame URLs.
...
<ParamField body="model" type="string" required placeholder="kling-plus/kling-o1-pro/start-end-frame-to-video">
  Model slug. Use `kling-plus/kling-o1-pro/start-end-frame-to-video` for start-end frame to video generation.
</ParamField>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "kling-plus/kling-o1-pro/start-end-frame-to-video",
    "input": {
