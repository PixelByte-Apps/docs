---
title: "Kling O1 Standard — Start-End Frame to Video"
api: "POST /v1/jobs/submit"
description: "Generate videos with the Kling O1 Standard model using start-end frame to video."
---
...
<ParamField body="model" type="string" required placeholder="kling-plus/kling-o1-standard/start-end-frame-to-video">
