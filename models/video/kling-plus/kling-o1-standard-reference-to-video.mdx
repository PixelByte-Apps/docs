---
title: "Kling O1 Standard — Reference to Video"
api: "POST /v1/jobs/submit"
description: "Generate videos with the Kling O1 Standard model using reference to video."
---
...
<ParamField body="model" type="string" required placeholder="kling-plus/kling-o1-standard/reference-to-video">
