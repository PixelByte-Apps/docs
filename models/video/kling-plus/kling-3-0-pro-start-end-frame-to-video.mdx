...
description: "Generate start-end frame to video using Kling 3.0 Pro via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="kling-plus/kling-3.0-pro/start-end-frame-to-video">
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "kling-plus/kling-3.0-pro/start-end-frame-to-video",
    "input": {
