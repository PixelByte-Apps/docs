---
title: "Kling O1 Pro — Video Edit"
api: "POST /v1/jobs/submit"
description: "Generate videos with the Kling O1 Pro model using video edit."
---

Edit an existing video using a natural-language instruction with the Kling O1 Pro model.
...
| **Base Cost** | 40,000 micro-cents/second ($0.040/sec) |
| **Processing Time** | ~180 seconds |

## Request Body

<ParamField body="model" type="string" required placeholder="kling-plus/kling-o1-pro/video-edit">
  Model slug. Use `kling-plus/kling-o1-pro/video-edit` for video edit generation.
</ParamField>
...
**Base cost:** 40,000 micro-cents per second ($0.040/sec)
...
<Tip>
**Cost:** flat **40,000 micro-cents ($0.040)** per video.
</Tip>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "kling-plus/kling-o1-pro/video-edit",
    "input": {
