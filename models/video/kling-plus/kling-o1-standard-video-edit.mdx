---
title: "Kling O1 Standard — Video Edit"
api: "POST /v1/jobs/submit"
description: "Generate videos with the Kling O1 Standard model using video edit."
---

Edit an existing video using a natural-language instruction with the Kling O1 Standard model.
...
<ParamField body="model" type="string" required placeholder="kling-plus/kling-o1-standard/video-edit">
  Model slug. Use `kling-plus/kling-o1-standard/video-edit` for video edit generation.
</ParamField>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "kling-plus/kling-o1-standard/video-edit",
    "input": {
