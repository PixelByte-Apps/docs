...
description: "Animate images into videos using Google's Veo 3.1 Fast model"
---
...
<ParamField body="model" type="string" required placeholder="google/veo-3.1-fast/image-to-video">
