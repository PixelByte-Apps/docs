...
description: "Generate videos from text prompts using Google's Veo 3.1 Fast model"
---
...
<ParamField body="model" type="string" required placeholder="google/veo-3.1-fast/text-to-video">
