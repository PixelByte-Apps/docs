...
description: "Generate videos using Gen 4.5 via PixelByte API"
---

Generate high-quality videos with Runway's Gen 4.5 model. Supports text-to-video and image-to-video capabilities with flexible duration options up to 10 seconds and multiple aspect ratios.
...
**Slug:** `runway/gen-4.5/text-to-video`

### Request Body

<ParamField body="model" type="string" required placeholder="runway/gen-4.5/text-to-video">
...
**Slug:** `runway/gen-4.5/image-to-video`
