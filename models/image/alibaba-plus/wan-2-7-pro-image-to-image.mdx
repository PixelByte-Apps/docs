---
title: "Wan 2.7 Pro — Image to Image / Edit"
api: "POST /v1/jobs/submit"
description: "Generate image to image / edit outputs using Alibaba+'s Wan 2.7 Pro model via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="alibaba-plus/wan-2.7-pro/image-to-image">
