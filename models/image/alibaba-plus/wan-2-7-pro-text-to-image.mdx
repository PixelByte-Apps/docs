...
description: "Generate text to image outputs using Alibaba+'s Wan 2.7 Pro model via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="alibaba-plus/wan-2.7-pro/text-to-image">
