...
description: "Generate and edit images using OpenAI's GPT Image 1.5 model via PixelByte API"
---

Generate images from text descriptions with OpenAI's GPT Image 1.5 model. Supports text-to-image generation and image editing.
...
<ParamField body="model" type="string" required placeholder="openai/gpt-image-1.5/text-to-image">
