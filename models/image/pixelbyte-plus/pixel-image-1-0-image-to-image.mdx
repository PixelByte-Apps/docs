---
title: "Pixel Image 1.0 — Image to Image / Edit"
api: "POST /v1/jobs/submit"
description: "Edit and transform images using PixelByte+'s Pixel Image 1.0 model"
---

Edit and transform existing images with PixelByte+'s Pixel Image 1.0 model. Provide one or more reference images along with an edit instruction to guide the transformation.
...
<ParamField body="model" type="string" required placeholder="pixelbyte-plus/pixel-image-1.0/image-to-image">
  Model slug. Use `pixelbyte-plus/pixel-image-1.0/image-to-image` for image editing.
</ParamField>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "pixelbyte-plus/pixel-image-1.0/image-to-image",
    "input": {
