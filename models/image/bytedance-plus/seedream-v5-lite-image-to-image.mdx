---
title: "Seedream V5 Lite — Image to Image / Edit"
api: "POST /v1/jobs/submit"
description: "Edit images while preserving facial features, lighting, and color tones using ByteDance+ Seedream V5 Lite"
---
...
<ParamField body="model" type="string" required placeholder="bytedance-plus/seedream-v5-lite/image-to-image">
...
<ParamField body="input" type="object" required>
  ...
  <Expandable title="properties" defaultOpen>
    ...
    <ParamField body="resolution" type="string">
      Output resolution. Default: `2K`. Options: `1K`, `2K`.
    </ParamField>
...
curl -X POST https://api.muvi.video/v1/jobs/submit \
  ...
  -d '{
    "model": "bytedance-plus/seedream-v5-lite/image-to-image",
    "input": {
      "prompt": "Add a futuristic city background while preserving the subject",
