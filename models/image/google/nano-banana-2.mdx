...
description: "Generate and edit images using Google's Nano Banana 2 model via PixelByte API"
---
...
<ParamField body="model" type="string" required placeholder="google/nano-banana-2">
  Model slug. Use `google/nano-banana-2` for text-to-image generation.
</ParamField>
...
Edit and transform existing images using Google's Nano Banana 2 model. Provide reference images along with a text prompt to guide the editing process.
...
<ParamField body="model" type="string" required placeholder="google/nano-banana-2/edit-image">
  Model slug. Use `google/nano-banana-2/edit-image` for image editing.
</ParamField>
