...
description: "Generate images from text prompts using Google's Nano Banana 2 model"
---
...
<ParamField body="model" type="string" required placeholder="google/nano-banana-2/text-to-image">
