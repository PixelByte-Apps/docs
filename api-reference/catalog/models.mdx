...
curl -X GET https://api.pixelbyte.app/v1/catalog/models
...
# Public access
response = requests.get("https://api.pixelbyte.app/v1/catalog/models")

# With auth for personalized results
response = requests.get(
    "https://api.pixelbyte.app/v1/catalog/models",
...
// Public access
const response = await fetch("https://api.pixelbyte.app/v1/catalog/models");

// With auth for personalized results
const authResponse = await fetch("https://api.pixelbyte.app/v1/catalog/models", {
  headers: { "Authorization": "Bearer YOUR_TOKEN" }
});
