...
```bash cURL
curl -X GET https://api.pixelbyte.app/v1/jobs/job_abc123def456 \
...
response = requests.get(
    "https://api.pixelbyte.app/v1/jobs/job_abc123def456",
    headers={
        "Authorization": "Bearer YOUR_API_KEY"
    }
)
...
```json
{
  ...
  "status": "completed",
  "progress": 100,
  "output": "https://cdn.pixelbyte.app/outputs/job_abc123def456/output_0.mp4",
  "outputs": [
    {
      "url": "https://cdn.pixelbyte.app/outputs/job_abc123def456/output_0.mp4",
      "type": "video",
      "thumbnail": "https://cdn.pixelbyte.app/outputs/job_abc123def456/thumb_0.jpg",
      "posterImage": "https://cdn.pixelbyte.app/outputs/job_abc123def456/poster_0.jpg"
    }
  ],
  "error": null,
